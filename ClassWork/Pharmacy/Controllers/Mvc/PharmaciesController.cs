...
namespace Pharmacy.Controllers.Mvc
{
    ...
    public class PharmaciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,EstablishedOn")] global::Pharmacy.Models.Pharmacy pharmacy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,EstablishedOn")] global::Pharmacy.Models.Pharmacy pharmacy)
        {
            if (id != pharmacy.Id)
            {
                return NotFound();
